...
先学 20 是主干 42 的子集，不是另一套卡，也不含框架选型和源码拆解：模型 01/02/06/07/08 → 推理 37/30 → 上下文与检索 14/15/17/18 → 智能体与评测 20/21/22/23/39 → 生产 41/42/40/35。
